...
//   const $statistics = useQuery(`statistics.${classId}.${subjectId}`, () =>
...
//               </TableHead>
//               <TableBody>
//                 {$statistics.data.statistics.map((student) => (
//                   <TableRow
//                     key={student._id}
...
const Statistics = ({
  ...
  const sortedData = React.useMemo(() => {
    ...
    return dataCopy.sort((a, b) => {
      ...
      // Check if the key is a valid property of TStatisticStudent
